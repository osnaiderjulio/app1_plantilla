                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>NexoNest</b> Comercio electronico</h1>
    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    nos emociona presentarte nuestra categoría destacada que elevará tu experiencia de compra a nuevos niveles! Enfocados en brindarte lo último y lo mejor, nuestra categoría del mes 
                    está repleta de productos innovadores y emocionantes que no querrás perderte.
                </p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        ¡Bienvenido a nuestra tienda online, el destino perfecto para descubrir productos destacados que transformarán tu experiencia de compra! Sumérgete en un mundo de innovación y calidad, donde cada producto ha sido cuidadosamente 
                        seleccionado para satisfacer tus necesidades y superar tus expectativas.
                    </p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">Zapatos Nike Nube</a>
                            <p class="card-text">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">NexoNest</h2>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            Copyright &copy; 2023 <span> Universidad de córdoba |  <a rel="sponsored" href="https://www.unicordoba.edu.co/" target="_blank">Unicor</a> </span><br>
                            <span>Integrantes:</span><br>
                            <span>1-Luis Fernando Camaño</span><br>
                            <span>2-Osnaider julio López</span><br>
                            <span>3-Miguel Angel Palencia Guerra</span><br>
                            <span>4-Steven camilo López López</span>
